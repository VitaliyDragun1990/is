package com.revenat.ishop.presentation.config;
...
import com.revenat.ishop.presentation.filter.ClientLocaleDefinerFilter;
...
import com.revenat.ishop.presentation.listener.IShopApplicationListener;
...
public class IShopWebApplicationInitializer implements WebApplicationInitializer {
	...
	private WebApplicationContext createWebApplicaitonContext(ServletContext container) {
		...
		ctx.scan("com.revenat.ishop.infrastructure.config", "com.revenat.ishop.application.config");
