...
public class MyOrdersController extends AbstractController {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		List<Order> userOrders = getOrderManager().findByUser(req.getSession(), 1, Constants.MAX_ORDERS_PER_HTML_PAGE);
		int totalOrderCount = getOrderManager().coundByUser(req.getSession());
