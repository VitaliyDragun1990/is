...
@EnableJpaRepositories(basePackages = "com.revenat.ishop.infrastructure.repository")
public class JPAConfig {
	 ...
	 * shutdown method are automatically enlisted with a destruction callback.
	 */
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan("com.revenat.ishop.domain.entity");
