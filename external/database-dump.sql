...
DROP TRIGGER IF EXISTS productdelete ON product;
DROP TRIGGER IF EXISTS productinsert ON product;
DROP TRIGGER IF EXISTS productupdate ON product;

DROP FUNCTION IF EXISTS product_count_update_product();
DROP FUNCTION IF EXISTS product_count_insert_product();
DROP FUNCTION IF EXISTS product_count_delete_product();
...
DROP SEQUENCE IF EXISTS producer_id_seq;
